...
class DomoSDKExamples:
    def __init__(self):
        ...
        client_id = '6f751d5a-86dc-41a6-82ea-9cc3cc6738b9'
        client_secret = '49abd6c30959debf2f878afe36f7fda2c40588f6af4255ce9fdd0869e4ee9630'
    ...
    def domoTest(self):
        ...
        csv_upload = "\"Test2\",\"Yes\"\n\"Test3\",\"No\""

        dataset_id = "11407f20-7736-46c8-b74a-0c9834ff2b0c"

        datasets.data_import(dataset_id, csv_upload)
        #self.logger.info("Uploaded data to DataSet " + str(dataset_id.id))


    def createUpdateDataSets(self):
        datasets = self.domo.datasets
        ...
        self.logger.info("Created DataSet " + str(dataset))
    ...
    def importExportData(self, dataset):
        datasets = self.domo.datasets
    ...
    def pdps(self, dataset):
        ...
        pdp_request.users = [45, 58]  # The affected user ids (restricted access by filter)
        pdp_request.groups = [2, 3]  # The affected group ids (restricted access by filter)
    ...
    def runVideoExamples(self):
        dataset = self.createUpdateDataSets()
        self.importExportData(dataset)
        self.pdps(dataset)
